    ...
    return (
      ...
      (e.prototype._getNextDelay = function() {
        var e = this._options,
          ...
          n = void 0 === t ? s.reconnectionDelayGrowFactor : t,
          o = e.minReconnectionDelay,
          r = void 0 === o ? s.minReconnectionDelay : o,
          i = e.maxReconnectionDelay,
          c = void 0 === i ? s.maxReconnectionDelay : i,
          u = r;
        return (
          this._retryCount > 0 &&
            (u = r * Math.pow(n, this._retryCount - 1)) > c &&
            (u = c),
      ...
      (e.prototype._connect = function() {
        ...
        if (!this._connectLock && this._shouldReconnect) {
          ...
          var t = this._options,
            n = t.maxRetries,
            o = void 0 === n ? s.maxRetries : n,
            r = t.connectionTimeout,
            c = void 0 === r ? s.connectionTimeout : r,
            u = t.WebSocket,
            a = void 0 === u ? i() : u;
          if (this._retryCount >= o)
            ...
            if (
              ...
              "function" != typeof (h = a) || 2 !== h.CLOSING)
            )
